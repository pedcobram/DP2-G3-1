...
public class AuthenticatedE2ETest {
	...
	void testFindFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/authenticateds").param("lastName", "Rodríguez Flores")).andExpect(MockMvcResultMatchers.status().is3xxRedirection()).andExpect(MockMvcResultMatchers.view().name("redirect:/authenticateds/1"));
	}
	...
	void testInitUpdateAuthenticatedSuccess() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/myProfile/1/edit")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("authenticateds/createOrUpdateAuthenticatedForm"))
	...
	void testUpdateFormLastNameError() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/myProfile/1/edit").param("firstName", "AuthQ").param("lastName", "").param("dni", "12345678T").param("email", "auth@test.com").param("telephone", "657063253").param("user.username", "auth1")
				.param("user.password", "auth").with(SecurityMockMvcRequestPostProcessors.csrf()))
	...
	void testUpdateFormDNIError() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/myProfile/1/edit").param("firstName", "AuthQ").param("lastName", "TEst").param("dni", "128T").param("email", "auth@test.com").param("telephone", "657063253").param("user.username", "ignacio")
				.param("user.password", "ignacio").with(SecurityMockMvcRequestPostProcessors.csrf()))
			.andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("authenticateds/createOrUpdateAuthenticatedForm"))
			.andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/authenticateds/createOrUpdateAuthenticatedForm.jsp"));
	}
	@WithMockUser(username = "ignacio", authorities = {
	...
	void testUpdateFormEmailError() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/myProfile/1/edit").param("firstName", "AuthQ").param("lastName", "TEst").param("dni", "12345678T").param("email", "").param("telephone", "657063253").param("user.username", "auth1")
				.param("user.password", "auth").with(SecurityMockMvcRequestPostProcessors.csrf()))
	...
	void testUpdateFormTelephoneError() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/myProfile/1/edit").param("firstName", "AuthQ").param("lastName", "TEst").param("dni", "12345678T").param("email", "auth@test.com").param("telephone", "65fyh53").param("user.username", "auth1")
				.param("user.password", "auth").with(SecurityMockMvcRequestPostProcessors.csrf()))
	...
	void testShowAuthenticatedSuccess() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/authenticateds/1")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("authenticated"))
	...
	void testShowAuthenticatedProfileSuccess() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/myProfile/ignacio")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("authenticated"))
			.andExpect(MockMvcResultMatchers.view().name("authenticateds/authenticatedDetails")).andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/authenticateds/authenticatedDetails.jsp"));
	}
