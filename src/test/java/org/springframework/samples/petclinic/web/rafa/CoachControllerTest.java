...
public class CoachControllerTest {
	...
	void setup() {
		...
		this.shinraInc.setId(TEST_FOOTBALL_CLUB_ID);
		...
		anotherClub.setId(TEST_FOOTBALL_CLUB_ID + 1);
		...
		this.sephirot.setId(TEST_COACH_ID);
		...
		anotherCoach.setId(TEST_COACH_ID + 1);
		...
		anotherCoachWithClub.setId(TEST_COACH_ID + 2);
		
		BDDMockito.given(this.footballClubService.findFootballClubByPresident("rufus")).willReturn(this.shinraInc);
		BDDMockito.given(this.coachService.findCoachByClubId(TEST_FOOTBALL_CLUB_ID)).willReturn(this.sephirot);
		BDDMockito.given(this.coachService.findCoachById(TEST_COACH_ID)).willReturn(this.sephirot);
		BDDMockito.given(this.coachService.findCoachById(TEST_COACH_ID + 1)).willReturn(anotherCoach);
		BDDMockito.given(this.coachService.findCoachById(TEST_COACH_ID + 2)).willReturn(anotherCoachWithClub);
	...
	void testShowCoach() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/{coachId}", TEST_COACH_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeExists("coach"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("clubId"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("clubStatus"))
				.andExpect(MockMvcResultMatchers.model().attribute("coach", Matchers.hasProperty("firstName", Matchers.is("Sephirot"))))
				.andExpect(MockMvcResultMatchers.model().attribute("coach", Matchers.hasProperty("lastName", Matchers.is("Jenova"))))
				.andExpect(MockMvcResultMatchers.model().attribute("coach", Matchers.hasProperty("salary", Matchers.is(4000000))))
				.andExpect(MockMvcResultMatchers.model().attribute("coach", Matchers.hasProperty("clause", Matchers.is(6000000))))
				.andExpect(MockMvcResultMatchers.model().attribute("coach", Matchers.hasProperty("club", Matchers.is(this.shinraInc))))	
				.andExpect(MockMvcResultMatchers.model().attribute("coach", Matchers.hasProperty("birthDate", Matchers.is(birthDate))))
				.andExpect(MockMvcResultMatchers.model().attribute("coachAge", Matchers.is(20)))
				.andExpect(MockMvcResultMatchers.view().name("coachs/coachDetails"))
				.andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/coachs/coachDetails.jsp"));
	}
	...
	void testInitCreationFormSuccess() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/new"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeExists("coach"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("regs"))
				.andExpect(MockMvcResultMatchers.view().name("coachs/createOrUpdateCoachForm"))	
	...
	void testInitCreationFormWithoutClub() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/new"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("coach"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("regs"))
	...
	void testProcessCreationFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/coachs/new")
				.with(SecurityMockMvcRequestPostProcessors.csrf())
				.param("firstName", "Barret")
				.param("lastName", "Wallace")
				.param("salary", "1000000")
				.param("birthDate", "2000/01/01"))
				.andExpect(MockMvcResultMatchers.status().is3xxRedirection())
				.andExpect(MockMvcResultMatchers.view().name("redirect:/coachs/null"));
	}
	...
	void testProcessCreationFormHasErrors() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/coachs/new")
				...
				.param("salary", "1000000")
				.param("birthDate", "2000/01/01"))
				.andExpect(MockMvcResultMatchers.model().attributeHasErrors("coach"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.view().name("coachs/createOrUpdateCoachForm"))
				.andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/coachs/createOrUpdateCoachForm.jsp"));
	}
	...
	void testInitSigningFormSuccess() throws Exception {	
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/{coachId}/sign", TEST_COACH_ID + 1))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeExists("coach"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("clubCoach"))
				.andExpect(MockMvcResultMatchers.model().attribute("freeAgent", Matchers.is(true)))
				.andExpect(MockMvcResultMatchers.model().attribute("iHaveCoach", Matchers.is(true)))
				.andExpect(MockMvcResultMatchers.model().attribute("toPayValue", Matchers.is(6000000 + " €")))
				.andExpect(MockMvcResultMatchers.model().attribute("myCoachFirstName", Matchers.is("Sephirot")))
				.andExpect(MockMvcResultMatchers.model().attribute("myCoachLastName", Matchers.is("Jenova")))
				.andExpect(MockMvcResultMatchers.model().attribute("clubName", Matchers.is("Shinra Inc")))
				.andExpect(MockMvcResultMatchers.model().attribute("readonly", Matchers.is(true)))
				.andExpect(MockMvcResultMatchers.view().name("coachs/createOrUpdateCoachForm"))	
				.andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/coachs/createOrUpdateCoachForm.jsp"));
	}
	...
	void testInitSigningFormWithoutClub() throws Exception {	
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/{coachId}/sign", TEST_COACH_ID + 1))
				...
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("coach"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("clubCoach"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("freeAgent"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("iHaveCoach"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("toPayValue"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("myCoachFirstName"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("myCoachLastName"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("clubName"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("readonly"))
				.andExpect(MockMvcResultMatchers.view().name("footballClubs/myClubEmpty"))
				.andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/footballClubs/myClubEmpty.jsp"));
	}
	...
	void testInitSigningFormWithClubNotPublished() throws Exception {	
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/{coachId}/sign", TEST_COACH_ID + 2))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("coach"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("clubCoach"))
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("freeAgent"))
	...
	void testProcessSigningFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/coachs/{coachId}/sign", TEST_COACH_ID + 1)
				.with(SecurityMockMvcRequestPostProcessors.csrf())
				.param("salary", "1000000")
				.param("firstName", "Another")
				.param("lastName", "Coach")
				.param("birthDate", "2000/02/11"))
				.andExpect(MockMvcResultMatchers.status().is3xxRedirection())
	...
	void testFireCoach() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/{coachId}/fire", TEST_COACH_ID))
				.andExpect(MockMvcResultMatchers.status().is3xxRedirection())
				.andExpect(MockMvcResultMatchers.view().name("redirect:/footballClubs/myClub/rufus"));
	}
	...
	void testFireCoachFAError() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/{coachId}/fire", TEST_COACH_ID + 1))
				.andExpect(MockMvcResultMatchers.view().name("exceptions/forbidden"))
				.andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/exceptions/forbidden.jsp"));
	}
	...
	void testFireCoachWrongPresident() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/coachs/{coachId}/fire", TEST_COACH_ID + 2))
				.andExpect(MockMvcResultMatchers.view().name("exceptions/forbidden"))
				.andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/jsp/exceptions/forbidden.jsp"));
	}
