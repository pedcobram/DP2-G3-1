...
public class RefereeRequestE2ETests {
	...
	void rejectRefereeRequest() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/refereeRequest/reject/{usuario}", "gonzalo")).andExpect(MockMvcResultMatchers.status().is3xxRedirection()).andExpect(MockMvcResultMatchers.view().name("redirect:/refereeRequest/list"));
	}
