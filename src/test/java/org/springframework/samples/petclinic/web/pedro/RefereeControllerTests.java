...
public class RefereeControllerTests {
	...
	void deleteReferee() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/deleteReferee/referee1")).andExpect(MockMvcResultMatchers.status().isOk());
	}

	@WithAnonymousUser
	@Test //CASO NEGATIVO
	void dontDeleteReferee() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/deleteReferee/referee1")).andExpect(MockMvcResultMatchers.status().is4xxClientError());
	}
	...
	void initUpdateRefereeForm() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/myRefereeProfile/1/edit")).andExpect(MockMvcResultMatchers.status().isOk());
	}

	@WithAnonymousUser
	@Test //CASO NEGATIVO
	void dontInitUpdateRefereeForm() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/myRefereeProfile/1/edit")).andExpect(MockMvcResultMatchers.status().is4xxClientError());
	}
	...
	void processUpdateRefereeForm() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/myRefereeProfile/1/edit")
	...
	void dontProcessUpdateRefereeForm() throws Exception {
		...
		.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("referee", "firstName"))
		.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("referee", "lastName"))
		.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("referee", "telephone"))
		.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("referee", "email"))
		.andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("referee", "dni"));
	}
	...
	void showRefereeProfile() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/myRefereeProfile/referee1")).andExpect(MockMvcResultMatchers.status().isOk());
	}

	@WithAnonymousUser
	@Test //CASO NEGATIVO
	void dontShowRefereeProfile() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/myRefereeProfile/referee1")).andExpect(MockMvcResultMatchers.status().is4xxClientError());
	}
