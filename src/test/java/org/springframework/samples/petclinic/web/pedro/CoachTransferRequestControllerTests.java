...
public class CoachTransferRequestControllerTests {
	...
	void setup() {
		...
		CoachTransferRequest ctr = createCoachTransferRequest(CoachTransferRequestControllerTests.TEST_MY_COACH_TRANSFER_REQUEST_ID, RequestStatus.ON_HOLD, myCoach, requestedCoach);
	...
	void testShowRequestTransferCoach() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/transfers/coaches/request/{coachId}", CoachTransferRequestControllerTests.TEST_REQUESTED_COACH_ID))
	...
	void testProcessCreationForm() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/transfers/coaches/request/{coachId}", CoachTransferRequestControllerTests.TEST_REQUESTED_COACH_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf())
				.param("offer", "1000000"))
			.andExpect(MockMvcResultMatchers.status().is3xxRedirection()).andExpect(MockMvcResultMatchers.view().name("redirect:/transfers/coaches"))
	...
	void testDeleteTransferPlayerRequest() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/transfers/coaches/requests/sent/delete/{requestId}", CoachTransferRequestControllerTests.TEST_MY_COACH_TRANSFER_REQUEST_ID))
	...
	void testRejectTransferPlayerRequest() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/transfers/coaches/requests/received/reject/{coachRequestId}", CoachTransferRequestControllerTests.TEST_MY_COACH_TRANSFER_REQUEST_ID))
			.andExpect(MockMvcResultMatchers.status().is3xxRedirection())
	...
	void testDontRejectTransferPlayerRequest() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/transfers/coaches/requests/received/reject/{coachId}", CoachTransferRequestControllerTests.TEST_MY_COACH_TRANSFER_REQUEST_ID))
			.andExpect(MockMvcResultMatchers.status().is4xxClientError());
	}
	...
	void testAcceptTransferPlayerRequest() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/transfers/coaches/requests/received/accept/{playerId}", CoachTransferRequestControllerTests.TEST_MY_COACH_TRANSFER_REQUEST_ID))
			.andExpect(MockMvcResultMatchers.status().is3xxRedirection())
			.andExpect(MockMvcResultMatchers.view().name("redirect:/transfers/coaches/requests/received"))
			.andExpect(MockMvcResultMatchers.redirectedUrl("/transfers/coaches/requests/received"));
	}
