...
public class FootballClubControllerTest {
	...
	void testProcessUpdateFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/footballClubs/myClub/{principalUsername}/edit", "rufus")
				.with(SecurityMockMvcRequestPostProcessors.csrf())
				.param("name", "ShinraEdit Inc")
				.param("city", "MidgarEdit")
	...
	void testShowFootballClubListHtml() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/footballClubs/list"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeExists("footballClubs"))
				.andExpect(MockMvcResultMatchers.model().attribute("footballClubs", Matchers.hasSize(1)))
	...
	void testShowFootballClubByUsername() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/footballClubs/myClub/{principalUsername}", "rufus"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeExists("footballClub"))
				...
				.andExpect(MockMvcResultMatchers.view().name("footballClubs/myClubDetails"))
	...
	void testShowFootballClubByUsernameWithoutClub() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/footballClubs/myClub/{principalUsername}", "presidentWithoutClub"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("footballClub"))
	...
	void testShowFootballClubByUsernameError() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/footballClubs/list/{principalUsername}", "rufus"))
				.andExpect(MockMvcResultMatchers.status().is4xxClientError());
	...
	void testShowFootballClub() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/footballClubs/list/{footballClubId}", FootballClubControllerTest.TEST_FOOTBALL_CLUB_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeExists("footballClub"))
				.andExpect(MockMvcResultMatchers.model().attributeExists("coach"))
				.andExpect(MockMvcResultMatchers.model().attribute("footballClub", Matchers.hasProperty("name", Matchers.is("Shinra Inc"))))
