...
public class CoachTransferRequestE2ETests {
	...
	//		this.mockMvc.perform(MockMvcRequestBuilders.get("/transfers/coaches/requests/received/reject/{coachRequestId}", CoachTransferRequestE2ETests.TEST_MY_COACH_TRANSFER_REQUEST_ID)).andExpect(MockMvcResultMatchers.status().isOkRedirection())
