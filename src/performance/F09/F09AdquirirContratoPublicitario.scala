...
class F09AdquirirContratoPublicitario extends Simulation {
	...
	val scn = scenario("F09AdquirirContratoPublicitario").exec(Home.home,
														Login.login,
	...
	setUp(
		scn.inject(rampUsers(1200) during (100 seconds))
