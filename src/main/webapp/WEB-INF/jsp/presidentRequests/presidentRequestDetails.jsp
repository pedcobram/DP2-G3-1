...
<petclinic:layout pageName="presidentRequestDetails">

    <h2><fmt:message key="code.title.presidentrequestdetails"/></h2>


    <table class="table table-striped">
        <tr>
            <th><fmt:message key="code.label.compadminrequestdetails.title"/></th>
            <td><b><c:out value="${presidentRequest.title}"/></b></td>
        </tr>
        <tr>
            <th><fmt:message key="code.label.compadminrequestdetails.description"/></th>
            <td><c:out value="${presidentRequest.description}"/></td>
        </tr>
        <tr>
            <th><fmt:message key="code.label.compadminrequestdetails.status"/></th>
            <td><c:out value="${presidentRequest.status}"/></td>
        </tr>
    </table>
	...
	<c:if test="${presidentRequest.user.username == principalUsername}">
    	<spring:url value="myPresidentRequest/edit" var="editUrl">  	</spring:url>
    	<a href="${fn:escapeXml(editUrl)}" class="btn btn-default"><fmt:message key="code.button.compadminrequestdetails.edit"/></a>
    	
    	
    	<spring:url value="/deletePresidentRequest" var="editUrl">  </spring:url>
