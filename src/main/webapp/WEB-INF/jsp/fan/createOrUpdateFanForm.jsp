            ...
            <div class="col-sm-offset-2 col-sm-10">
            	 <c:choose>
                        <c:when test="${isNew}">
            				...
            				<a href="/footballClub/fan/delete" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span><fmt:message key="delete"/></a>
                        </c:when>
                        <c:otherwise>
                            <button class="btn btn-default" type="submit"><span class="glyphicon glyphicon-ok"></span><fmt:message key="yesVip"/></button>
    						<a href="/" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span><fmt:message key="noVipnow"/></a>
							<a href="/footballClub/fan/delete" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span><fmt:message key="deleteVip"/></a>
                        </c:otherwise>
                    </c:choose>
            </div>
        </div>
