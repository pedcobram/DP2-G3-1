...
public class AuthoritiesService {
	...
	@Transactional
	public void deleteAuthorities(final Authorities authorities) throws DataAccessException {
		this.authoritiesRepository.delete(authorities);
	}

	@Transactional
	public void deleteAuthorities(final String username, final String role) throws DataAccessException {
		Authorities authority = new Authorities();
		this.authoritiesRepository.delete(authority);
	}
