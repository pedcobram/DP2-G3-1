...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/resources/**", "/webjars/**", "/h2-console/**").permitAll()
			...
			.antMatchers("/refereeRequest/**").authenticated()
			.antMatchers("/presidentRequest/**").authenticated()
			.antMatchers("/myPresidentRequest/**").authenticated()
			.antMatchers("/myRefereeRequest/**").authenticated()
			.antMatchers("/deletePresidentRequest/**").authenticated()
			.antMatchers("/deleteRefereeRequest/**").authenticated()
			...
			.antMatchers("/competition/**").hasAnyAuthority("competitionAdmin").anyRequest().denyAll().and().formLogin()
			/* .loginPage("/login") */
