...
public interface SpringDataPlayerTransferRequestRepository extends PlayerTransferRequestRepository, Repository<PlayerTransferRequest, Integer> {
	...
	Collection<PlayerTransferRequest> findByPresident(@Param("username") String username);
	...
	Integer countByPresidentAndPlayer(@Param("presidentUsername") String presidentUsername, @Param("playerId") int playerId);
