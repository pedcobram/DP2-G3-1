...
public interface SpringDataFootballPlayerStatisticsRepository extends FootballPlayerStatisticRepository, Repository<FootballPlayerStatistic, Integer> {
	...
	Collection<FootballPlayerStatistic> findAllFootballPlayerStatisticsBySeason(@Param("season_start") String season_start, @Param("season_end") String season_end);

	@Override
	@Query("SELECT a FROM FootballPlayerStatistic a WHERE a.id =:id")
	FootballPlayerStatistic findFootballPlayerStatisticById(@Param("id") int id);

	@Override
	@Query("SELECT a FROM FootballPlayerStatistic a WHERE a.player.id =:player_id")
	FootballPlayerStatistic findFootballPlayerStatisticByPlayerId(@Param("player_id") int player_id);
